...
public class Rocker {
    ...
    private float smallCenterX = 80, smallCenterY = 80, smallCenterR = 15;
    private float BigCenterX = 80, BigCenterY = 80, BigCenterR = 30;
    Paint paint;
		/*
    ...
    public float getDegrees(float firstX,float firstY,float secondX,float secondY ){
